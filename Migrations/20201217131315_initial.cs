    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HesabAccounts", x => x.ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HesabAccountID = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Deposits_HesabAccounts_HesabAccountID",
                        column: x => x.HesabAccountID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Expenses_HesabAccounts_HesabAccountID",
                        column: x => x.HesabAccountID,
                        principalTable: "HesabAccounts",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UserID = table.Column<string>(nullable: false),
                    HesabAccountID = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_HesabAccountUser", x => new { x.UserID, x.HesabAccountID });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Deposits_HesabAccountID",
                table: "Deposits",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Expenses_HesabAccountID",
                table: "Expenses",
                column: "HesabAccountID");
